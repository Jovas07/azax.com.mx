var carousel = (function(){
    ...
    var container = document.getElementById('carousel5'),
    ...
    function complete() {
        if ( animating ) {
            ...
            container.classList.remove( 'animate4' );
            // change the ordinal
            changeOrdinal();
    ...
    return {
        init: function() {
            var navigation = document.querySelectorAll( 'a.navigation4' );
