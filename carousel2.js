var carousel = (function(){
    ...
    var container = document.getElementById('carousel3'),
    ...
    function complete() {
        if ( animating ) {
            ...
            container.classList.remove( 'animate2' );
            // change the ordinal
            changeOrdinal();
    ...
    return {
        init: function() {
            var navigation = document.querySelectorAll( 'a.navigation2' );
